...
<div class="container-fluid" >
  <div class="row">
    <div class="col-sm-6 col-md-6 col-lg-8 ">
        <h1><span class="acceuil">Page D'inscription Des Services</span></h1> 
        <table class="liste">
            <tr> <th>#ID</th><th>Nom Service</th><th>Actions</th><tr>
    ...
    <form method="POST"  action="">
          <table class="table-center">
                <tr><th colspan="2" class="text-center"><legend>Inscription</legend></th></tr>
                
                <div class="form-group">
                    <tr>
                        <td><label for="idservice">Id Service: </label></td>
                        <td><input type="text" name="idservice" class="form-control"></td>
                    </tr>
                </div>
                <div class="form-group">
                    <tr>
                        <td><label for="nomservice">Nom Service: </label></td>
                        <td><input type="text" name="nomservice" class="form-control"></td>
                    </tr>
                </div>
                <div class="form-group">
                    <tr><td></td>
...
if(isset($_POST['enregistrer'])){
    ...
    if(!empty($_POST['nomservice'])){
        ...
        $nomservice = trim(htmlspecialchars($_POST['nomservice'])); 
       
    $donnes = ['Nom_Service'=>$nomservice];
